<template>
    <div class="banner">
        <div class="rrss">
            ...
            <a :href="informaciones.informacionGeneral.redesSociales.twitter"><b-icon icon="twitter"></b-icon></a>
            <a :href="informaciones.informacionGeneral.redesSociales.instagram"><b-icon icon="instagram"></b-icon></a>
        </div>
        <div class="info">
            <h4>Contacto</h4>
